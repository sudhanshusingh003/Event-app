        ...
        <div className=" flex flex-row justify-between mx-10 text-gray-400 ">
          ...
          <div className="">
            <p className=" text-sm md:text-base">
              Made with<span>&#10084;</span>by Vineet
            </p>
          </div>
        </div>
        <div className=" mb-5 mt-5 flex flex-row items-center justify-center">
          <a href="https://www.instagram.com/k_vineet002/" target="blank">
            <svg
          ...
          <a href="https://github.com/kvineet002" target="blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
          ...
          <a href="https://www.linkedin.com/in/vineet-kumar-1371a4262/ " target="blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
