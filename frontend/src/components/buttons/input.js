    ...
    <>
      <div className='relative w-full'>
        <input
          ...
          type='email'
          name='email'
          className='h-12 w-full cursor-default rounded-md border border-slate-800 bg-transparent p-3.5 text-slate-100 transition-colors duration-500 placeholder:select-none  placeholder:text-neutral-500 focus:border-[#8678F9] focus:outline-none'
        />
        <input
          ref={divRef}
          disabled
